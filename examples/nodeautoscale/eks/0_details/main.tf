...
resource "cloudpilotai_eks_cluster" "example" {
  ...
  nodeclass_templates = [
    {
      # Required
      template_name = "cloudpilotai-nodeclass-template"
  ...
  nodepool_templates = [
    {
      # Required.
      template_name = "cloudpilotai-nodepool-template"
      # Optional. Default is true.
      enable = true
  ...
  nodepools = [
    {
      ...
      enable = true
      # Select the nodeclass to use for this nodepool.
      # Required. A nodeclass must always be specified, either directly or inherited from template.
      nodeclass = "cloudpilotai-nodeclass"
