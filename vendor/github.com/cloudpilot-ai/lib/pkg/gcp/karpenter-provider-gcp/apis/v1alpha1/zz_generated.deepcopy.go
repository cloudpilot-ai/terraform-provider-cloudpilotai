...
import (
	status "github.com/cloudpilot-ai/lib/pkg/gcp/awslabs/operatorpkg/status"
...
func (in *AdditionalNetworkInterface) DeepCopyInto(out *AdditionalNetworkInterface) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AdditionalNetworkInterface.
func (in *AdditionalNetworkInterface) DeepCopy() *AdditionalNetworkInterface {
	if in == nil {
		return nil
	}
	out := new(AdditionalNetworkInterface)
	in.DeepCopyInto(out)
	return out
}
...
func (in *GCENodeClassSpec) DeepCopyInto(out *GCENodeClassSpec) {
	*out = *in
	...
	if in.EphemeralStorageLocalSSD != nil {
		in, out := &in.EphemeralStorageLocalSSD, &out.EphemeralStorageLocalSSD
		*out = new(EphemeralStorageLocalSSDConfig)
		(*in).DeepCopyInto(*out)
	}
...
func (in *NetworkConfig) DeepCopyInto(out *NetworkConfig) {
	*out = *in
	...
	if in.AdditionalNetworkInterfaces != nil {
		...
		*out = make([]AdditionalNetworkInterface, len(*in))
		copy(*out, *in)
	}
	return
}
